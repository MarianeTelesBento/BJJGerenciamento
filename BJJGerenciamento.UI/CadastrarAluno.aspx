        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <div class="input-group">
                    ...
                    <asp:Button ID="buscarCepAluno" runat="server" CssClass="btn btn-primary" OnClick="buscarCepAluno_Click" Text="Buscar" />
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <asp:TextBox ID="cepResponsavel" CssClass="form-control" runat="server" OnTextChanged="cepResponsavel_TextChanged"/>
                 <asp:Button ID="buscarCepResponsavel" runat="server" CssClass="btn btn-primary" OnClick="buscarCepResponsavel_Click" Text="Buscar" />
            </div>
    ...
    <div class="container mt-4">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <asp:DropDownList ID="ddPlanos" CssClass="form-control" runat="server" AutoPostBack="true" 
        ...
        <div class="col-12 text-center mt-3">
            <asp:Button ID="EnviarInformacoes" runat="server" CssClass="btn btn-primary" Text="Enviar" OnClick="btnEnviarInformacoes_Click" />
             <asp:Button ID="btnSalvarAluno" runat="server" CssClass="btn btn-success" OnClick="btnEnviarInformacoes_Click" Text="Salvar" />
 <asp:Button ID="btnCancelarAluno" runat="server" CssClass="btn btn-danger" OnClick="btnVoltar_Click" Text="Cancelar" />
        </div>
    </div>
</asp:Panel>
